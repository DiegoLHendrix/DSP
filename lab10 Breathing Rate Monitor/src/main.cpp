...
void setup() {
  ...
  MsTimer2::set(core::TSAMP_MSEC,
                core::ISR_Sample); // Set sample msec, ISR name
...
void loop() {
  ...
  core::printArray[0] =
      core::loopTick;             //  The sample number -- always print this
  ...
  core::WriteToSerial(
      core::numValues,
      core::printArray); //  Write to the serial monitor (or MATLAB)
